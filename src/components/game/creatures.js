...
Object.assign(CREATURE_REGISTRY, {
  ...
  kobold_archer:   (x,y,sc,fac,st,uid) => drawGoblin(x,y,sc,fac,st,uid,'archer'),
  lizardfolk:      (x,y,sc,fac,st,uid) => drawGoblin(x,y,sc,fac,st,uid,'dagger'),
  gnoll:           (x,y,sc,fac,st,uid) => drawOrc(x,y,sc,fac,st,uid,'warrior'),
  bugbear:         (x,y,sc,fac,st,uid) => drawTroll(x,y,sc,fac,st,uid),
  hobgoblin:       (x,y,sc,fac,st,uid) => drawOrc(x,y,sc,'enemy',st,uid,'warrior'),
  imp:             (x,y,sc,fac,st,uid) => drawGoblin(x,y,sc,'enemy',st,uid,'shaman'),
  pixie:           (x,y,sc,fac,st,uid) => drawGoblin(x,y,sc,'friendly',st,uid,'shaman'),
  cultist:         (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'enemy',st,uid,'thief'),
  dark_elf:        (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'enemy',st,uid,'thief'),
  high_elf:        (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'neutral',st,uid,'thief'),
  dwarf_npc:       (x,y,sc,fac,st,uid) => drawElder(x,y,sc,fac,st,uid),
  dire_wolf:       (x,y,sc,fac,st,uid) => drawWolf(x,y,sc,'enemy',st,uid),
  owlbear:         (x,y,sc,fac,st,uid) => drawTroll(x,y,sc,'enemy',st,uid),
  harpy:           (x,y,sc,fac,st,uid) => drawGhost(x,y,sc,'enemy',st,uid),
  manticore:       (x,y,sc,fac,st,uid) => drawDemon(x,y,sc,'enemy',st,uid),
  wyvern:          (x,y,sc,fac,st,uid) => drawDragon(x,y,sc,'enemy',st,uid),
  giant_spider:    (x,y,sc,fac,st,uid) => drawSpider(x,y,sc,'enemy',st,uid),
  fairy:           (x,y,sc,fac,st,uid) => drawGoblin(x,y,sc,'friendly',st,uid,'shaman'),
  centaur:         (x,y,sc,fac,st,uid) => drawWolf(x,y,sc,'neutral',st,uid),
  slime:           (x,y,sc,fac,st,uid) => drawGoblin(x,y,sc,'beast',st,uid,'shaman'),
  treant:          (x,y,sc,fac,st,uid) => drawTroll(x,y,sc,'neutral',st,uid),
  gargoyle:        (x,y,sc,fac,st,uid) => drawDemon(x,y,sc,'enemy',st,uid),
  will_o_wisp:     (x,y,sc,fac,st,uid) => drawGhost(x,y,sc,'beast',st,uid),
  // ── HORROR — monsters & NPCs ─────────────────────────────────────────────
  werewolf:        (x,y,sc,fac,st,uid) => drawWolf(x,y,sc,'enemy',st,uid),
  banshee:         (x,y,sc,fac,st,uid) => drawGhost(x,y,sc,'enemy',st,uid),
  poltergeist:     (x,y,sc,fac,st,uid) => drawGhost(x,y,sc,'enemy',st,uid),
  revenant:        (x,y,sc,fac,st,uid) => drawZombie(x,y,sc,'enemy',st,uid),
  doppelganger:    (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'enemy',st,uid,'thief'),
  blood_knight:    (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'enemy',st,uid),
  ghoul:           (x,y,sc,fac,st,uid) => drawZombie(x,y,sc,'enemy',st,uid),
  investigator:    (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'neutral',st,uid,'thief'),
  shadow_beast:    (x,y,sc,fac,st,uid) => drawWraith(x,y,sc,'enemy',st,uid),
  // ── SPACE / SCI-FI ───────────────────────────────────────────────────────
  space_marine:    (x,y,sc,fac,st,uid) => drawAndroid(x,y,sc,fac,st,uid),
  alien_bug:       (x,y,sc,fac,st,uid) => drawAlienGrey(x,y,sc,'enemy',st,uid),
  alien_beast:     (x,y,sc,fac,st,uid) => drawAlienGrey(x,y,sc,'enemy',st,uid),
  corrupted_ai:    (x,y,sc,fac,st,uid) => drawRobotDrone(x,y,sc,'enemy',st,uid),
  security_drone:  (x,y,sc,fac,st,uid) => drawRobotDrone(x,y,sc,'enemy',st,uid),
  ai_entity:       (x,y,sc,fac,st,uid) => drawRobotDrone(x,y,sc,'neutral',st,uid),
  rebel_soldier:   (x,y,sc,fac,st,uid) => drawGuard(x,y,sc,'enemy',st,uid),
  scientist_npc:   (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  pilot_npc:       (x,y,sc,fac,st,uid) => drawAndroid(x,y,sc,'friendly',st,uid),
  mechanic_npc:    (x,y,sc,fac,st,uid) => drawMerchant(x,y,sc,'neutral',st,uid),
  bounty_hunter:   (x,y,sc,fac,st,uid) => drawGunslinger(x,y,sc,'neutral',st,uid),
  mercenary:       (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'neutral',st,uid,'bandit'),
  // ── OCEAN ────────────────────────────────────────────────────────────────
  sailor:          (x,y,sc,fac,st,uid) => drawPirateNpc(x,y,sc,'neutral',st,uid),
  naval_officer:   (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'neutral',st,uid),
  harbormaster:    (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  dockworker:      (x,y,sc,fac,st,uid) => drawMerchant(x,y,sc,'neutral',st,uid),
  siren:           (x,y,sc,fac,st,uid) => drawMageNpc(x,y,sc,'enemy',st,uid),
  deep_one:        (x,y,sc,fac,st,uid) => drawZombie(x,y,sc,'enemy',st,uid),
  shark:           (x,y,sc,fac,st,uid) => drawWolf(x,y,sc,'enemy',st,uid),
  sea_serpent:     (x,y,sc,fac,st,uid) => drawKraken(x,y,sc,'enemy',st,uid),
  leviathan:       (x,y,sc,fac,st,uid) => drawDragon(x,y,sc,'enemy',st,uid),
  undead_sailor:   (x,y,sc,fac,st,uid) => drawSkeleton(x,y,sc,'enemy',st,uid,'warrior'),
  smuggler:        (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'neutral',st,uid,'thief'),
  // ── WESTERN ──────────────────────────────────────────────────────────────
  cowboy_npc:      (x,y,sc,fac,st,uid) => drawGunslinger(x,y,sc,'neutral',st,uid),
  deputy:          (x,y,sc,fac,st,uid) => drawGuard(x,y,sc,'friendly',st,uid),
  bartender:       (x,y,sc,fac,st,uid) => drawMerchant(x,y,sc,'friendly',st,uid),
  saloon_keeper:   (x,y,sc,fac,st,uid) => drawMerchant(x,y,sc,'friendly',st,uid),
  preacher:        (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'friendly',st,uid),
  frontier_doc:    (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'friendly',st,uid),
  prospector:      (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  cattle_rustler:  (x,y,sc,fac,st,uid) => drawGunslinger(x,y,sc,'enemy',st,uid),
  train_robber:    (x,y,sc,fac,st,uid) => drawGunslinger(x,y,sc,'enemy',st,uid),
  native_warrior:  (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'neutral',st,uid,'thief'),
  gambler_npc:     (x,y,sc,fac,st,uid) => drawMerchant(x,y,sc,'neutral',st,uid),
  drifter:         (x,y,sc,fac,st,uid) => drawGunslinger(x,y,sc,'neutral',st,uid),
  // ── POST-APOCALYPTIC ─────────────────────────────────────────────────────
  super_mutant:    (x,y,sc,fac,st,uid) => drawTroll(x,y,sc,'enemy',st,uid),
  ghoul_raider:    (x,y,sc,fac,st,uid) => drawZombie(x,y,sc,'enemy',st,uid),
  ghoul_npc:       (x,y,sc,fac,st,uid) => drawZombie(x,y,sc,'neutral',st,uid),
  feral_dog:       (x,y,sc,fac,st,uid) => drawWolf(x,y,sc,'enemy',st,uid),
  wasteland_beast: (x,y,sc,fac,st,uid) => drawWolf(x,y,sc,'enemy',st,uid),
  vault_dweller:   (x,y,sc,fac,st,uid) => drawGuard(x,y,sc,'friendly',st,uid),
  survivor:        (x,y,sc,fac,st,uid) => drawGuard(x,y,sc,'neutral',st,uid),
  tribesman:       (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'neutral',st,uid,'bandit'),
  tech_priest:     (x,y,sc,fac,st,uid) => drawMageNpc(x,y,sc,'neutral',st,uid),
  wasteland_trader:(x,y,sc,fac,st,uid) => drawMerchant(x,y,sc,'friendly',st,uid),
  warlord_npc:     (x,y,sc,fac,st,uid) => drawTroll(x,y,sc,'enemy',st,uid),
  // ── CYBERPUNK ────────────────────────────────────────────────────────────
  corpo_agent:     (x,y,sc,fac,st,uid) => drawGuard(x,y,sc,'enemy',st,uid),
  security_guard:  (x,y,sc,fac,st,uid) => drawGuard(x,y,sc,'neutral',st,uid),
  gang_member:     (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'enemy',st,uid,'bandit'),
  street_thug:     (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'enemy',st,uid,'bandit'),
  fixer_npc:       (x,y,sc,fac,st,uid) => drawMerchant(x,y,sc,'neutral',st,uid),
  ripperdoc:       (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  maxtac:          (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'enemy',st,uid),
  maxtac_officer:  (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'enemy',st,uid),
  gang_boss:       (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'boss',st,uid,'bandit'),
  hacker_npc:      (x,y,sc,fac,st,uid) => drawNetrunner(x,y,sc,'neutral',st,uid),
  yakuza_cyber:    (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'enemy',st,uid,'thief'),
  // ── NINJA / SAMURAI ──────────────────────────────────────────────────────
  onmyoji:         (x,y,sc,fac,st,uid) => drawMageNpc(x,y,sc,fac,st,uid),
  kunoichi:        (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'enemy',st,uid,'thief'),
  daimyo:          (x,y,sc,fac,st,uid) => drawSamurai(x,y,sc,'boss',st,uid),
  war_monk:        (x,y,sc,fac,st,uid) => drawSamurai(x,y,sc,'neutral',st,uid),
  temple_guardian: (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'neutral',st,uid),
  yakuza:          (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'enemy',st,uid,'bandit'),
  clan_warrior:    (x,y,sc,fac,st,uid) => drawSamurai(x,y,sc,'neutral',st,uid),
  monk:            (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'friendly',st,uid),
  geisha:          (x,y,sc,fac,st,uid) => drawMerchant(x,y,sc,'neutral',st,uid),
  river_spirit:    (x,y,sc,fac,st,uid) => drawGhost(x,y,sc,'neutral',st,uid),
  mountain_spirit: (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  // Japanese yokai — mapped to closest visual
  tengu:           (x,y,sc,fac,st,uid) => drawGhost(x,y,sc,'enemy',st,uid),
  kappa:           (x,y,sc,fac,st,uid) => drawGoblin(x,y,sc,'enemy',st,uid,'dagger'),
  oni:             (x,y,sc,fac,st,uid) => drawDemon(x,y,sc,'enemy',st,uid),
  kitsune:         (x,y,sc,fac,st,uid) => drawWitch(x,y,sc,'neutral',st,uid),
  fox_spirit:      (x,y,sc,fac,st,uid) => drawWitch(x,y,sc,'neutral',st,uid),
  // ── MYTHOLOGY ────────────────────────────────────────────────────────────
  medusa:          (x,y,sc,fac,st,uid) => drawWitch(x,y,sc,'enemy',st,uid),
  hydra:           (x,y,sc,fac,st,uid) => drawDragon(x,y,sc,'enemy',st,uid),
  sphinx:          (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  satyr:           (x,y,sc,fac,st,uid) => drawGoblin(x,y,sc,'neutral',st,uid,'shaman'),
  cerberus:        (x,y,sc,fac,st,uid) => drawWolf(x,y,sc,'enemy',st,uid),
  griffin:         (x,y,sc,fac,st,uid) => drawDemon(x,y,sc,'neutral',st,uid),
  olympian:        (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'friendly',st,uid),
  god_npc:         (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  fury:            (x,y,sc,fac,st,uid) => drawDemon(x,y,sc,'enemy',st,uid),
  demigod:         (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'friendly',st,uid),
  chimera:         (x,y,sc,fac,st,uid) => drawDemon(x,y,sc,'enemy',st,uid),
  pegasus:         (x,y,sc,fac,st,uid) => drawWolf(x,y,sc,'friendly',st,uid),
  harpy_myth:      (x,y,sc,fac,st,uid) => drawGhost(x,y,sc,'enemy',st,uid),
  // ── FAIRY TALE ───────────────────────────────────────────────────────────
  enchanted_knight:(x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'neutral',st,uid),
  dark_fairy:      (x,y,sc,fac,st,uid) => drawWitch(x,y,sc,'enemy',st,uid),
  forest_spirit:   (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  evil_queen:      (x,y,sc,fac,st,uid) => drawWitch(x,y,sc,'enemy',st,uid),
  woodcutter:      (x,y,sc,fac,st,uid) => drawMerchant(x,y,sc,'friendly',st,uid),
  princess_npc:    (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'friendly',st,uid),
  talking_animal:  (x,y,sc,fac,st,uid) => drawWolf(x,y,sc,'friendly',st,uid),
  helpful_mouse:   (x,y,sc,fac,st,uid) => drawRat(x,y,sc,'friendly',st,uid),
  cursed_beast:    (x,y,sc,fac,st,uid) => drawTroll(x,y,sc,'neutral',st,uid),
  beanstalk_giant: (x,y,sc,fac,st,uid) => drawTroll(x,y,sc,'enemy',st,uid),
  wood_elf:        (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'friendly',st,uid,'thief'),
  forest_elf:      (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'neutral',st,uid,'thief'),
  // ── HISTORICAL ───────────────────────────────────────────────────────────
  gladiator_npc:   (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'neutral',st,uid),
  spartan:         (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'enemy',st,uid),
  greek_hoplite:   (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'neutral',st,uid),
  crusader:        (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'friendly',st,uid),
  templar:         (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'friendly',st,uid),
  aztec_warrior:   (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'enemy',st,uid),
  inca_warrior:    (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'neutral',st,uid),
  egyptian_priest: (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  pharaoh_npc:     (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'boss',st,uid),
  medieval_soldier:(x,y,sc,fac,st,uid) => drawGuard(x,y,sc,'neutral',st,uid),
  feudal_lord:     (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  condottiere:     (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'neutral',st,uid),
  senator:         (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  nobleman:        (x,y,sc,fac,st,uid) => drawElder(x,y,sc,'neutral',st,uid),
  guardian_npc:    (x,y,sc,fac,st,uid) => drawKnight(x,y,sc,'neutral',st,uid),
  archer_npc:      (x,y,sc,fac,st,uid) => drawBandit(x,y,sc,'neutral',st,uid,'thief'),
  traveler_npc:    (x,y,sc,fac,st,uid) => drawMerchant(x,y,sc,'neutral',st,uid),
  shade:           (x,y,sc,fac,st,uid) => drawGhost(x,y,sc,'enemy',st,uid),
  scorpion:        (x,y,sc,fac,st,uid) => drawSpider(x,y,sc,'enemy',st,uid),
});
