...
export default function AuthOverlay({ onClose, onSuccess }) {
      ...
      <div className={styles.overlay} onClick={e => e.target === e.currentTarget && onClose()}>
        <div className={styles.panel}>
          <div className={styles.header}>
            <span className={styles.title}>☁ Cloud Saves</span>
            <button className={styles.close} onClick={onClose}>✕</button>
          </div>
          <div className={styles.notConfigured}>
            <div className={styles.notConfiguredIcon}>⚙</div>
            <p>Supabase isn't configured yet. Add your Supabase URL and anon key to enable cloud saves.</p>
            <p className={styles.hint}>Saves still work locally on this device.</p>
          </div>
        </div>
      </div>
    );
        ...
        {checking ? (
          ...
          <div className={styles.signedIn}>
            ...
            <div className={styles.cloudStatus}>
              ...
              <span>Cloud saves active — your progress syncs across devices</span>
            </div>
          ...
          <div className={styles.signIn}>
            <p className={styles.sub}>Sign in to save your adventures to the cloud and play from any device.</p>
            ...
            <p className={styles.localNote}>
              No account? Saves still work on this device via local storage.
            </p>
          </div>
        )}
      </div>
